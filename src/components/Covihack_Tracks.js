                ...
                <div className="row">
                    <div className="col-5 track-title">
                        ...
                        <div className="ai d-flex" style={{marginTop:'8px'}}>
                            <img src={ai}  data-aos="fade-right"/> <b>Artificial Intelligence</b>
                        </div>
                        <div className="ar-vr d-flex" style={{marginTop:'6px'}}>
                            <img src={vr}  data-aos="fade-right"/> <b>AR/VR</b>
                        </div>
                        <div className="financial-tech d-flex" style={{marginTop:'0px'}}>
                            <img src={ft}  data-aos="fade-right"/> <b>Financial Technology</b>
                        </div>
                        <div className="social-good d-flex" style={{marginTop:'2px'}}>
                            <img src={sg}  data-aos="fade-right"/> <b>Social Good</b>
                        </div>
                        <div className="iot d-flex" style={{marginTop:'20px'}}>
                            <img src={iot}  data-aos="fade-right"/> <b>Internet of Things</b>
                        </div>
                        <div className="healthcare d-flex" style={{marginTop:'18px'}}>
                            <img src={hc}  data-aos="fade-right"/> <b>Healthcare</b>
                        </div>
                        <div className="mobility d-flex" style={{marginTop:'0px'}}>
                            <img src={service}  data-aos="fade-right"/> <b>Mobility</b>
                        </div>
                    </div>

                    <div className="col-7 track-title-desc">
                        <div className="row blockchain"  data-aos="fade-left">
                        ...
                        <div className="row ai"  data-aos="fade-left">
                        ...
                        <div className="row ar-vr"  data-aos="fade-left">
                        ...
                        <div className="row financial-tech"  data-aos="fade-left">
                        ...
                        <div className="row social-good"  data-aos="fade-left">
                        ...
                        <div className="row iot"  data-aos="fade-left">
                        ...
                        <div className="row healthcare"  data-aos="fade-left">
                        ...
                        <div className="row mobility"  data-aos="fade-left">
